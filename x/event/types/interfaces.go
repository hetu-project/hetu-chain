...
func NewQueryClient(conn grpc.ClientConnInterface) QueryClient {
	return &queryClientWrapper{eventtypes.NewQueryClient(conn)}
}
...
// queryClientWrapper wraps the eventtypes.QueryClient to make it compatible with QueryClient.
type queryClientWrapper struct {
	client eventtypes.QueryClient
}

func (q *queryClientWrapper) Subnets(ctx context.Context, in *eventtypes.QuerySubnetsRequest, opts ...grpc.CallOption) (*eventtypes.QuerySubnetsResponse, error) {
	return q.client.Subnets(ctx, in, opts...)
}

func (q *queryClientWrapper) Subnet(ctx context.Context, in *eventtypes.QuerySubnetRequest, opts ...grpc.CallOption) (*eventtypes.QuerySubnetResponse, error) {
	return q.client.Subnet(ctx, in, opts...)
}

func (q *queryClientWrapper) SubnetNeurons(ctx context.Context, in *eventtypes.QuerySubnetNeuronsRequest, opts ...grpc.CallOption) (*eventtypes.QuerySubnetNeuronsResponse, error) {
	return q.client.SubnetNeurons(ctx, in, opts...)
}

func (q *queryClientWrapper) SubnetPool(ctx context.Context, in *eventtypes.QuerySubnetPoolRequest, opts ...grpc.CallOption) (*eventtypes.QuerySubnetPoolResponse, error) {
	return q.client.SubnetPool(ctx, in, opts...)
}

func (q *queryClientWrapper) ValidatorWeights(ctx context.Context, in *eventtypes.QueryValidatorWeightsRequest, opts ...grpc.CallOption) (*eventtypes.QueryValidatorWeightsResponse, error) {
	return q.client.ValidatorWeights(ctx, in, opts...)
}
