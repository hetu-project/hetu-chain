...
var (
	pattern_Msg_UpdateParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"evmos.inflation.v1.Msg", "UpdateParams"}, "", runtime.AssumeColonVerbOpt(true)))
)
