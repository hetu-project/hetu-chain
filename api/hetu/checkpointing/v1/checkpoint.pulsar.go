...
var (
	...
	fd_ValidatorWithBlsKey_dispatcher_url    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ValidatorWithBlsKey_dispatcher_url = md_ValidatorWithBlsKey.Fields().ByName("dispatcher_url")
}
...
func (x *fastReflection_ValidatorWithBlsKey) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DispatcherUrl != "" {
		value := protoreflect.ValueOfString(x.DispatcherUrl)
		if !f(fd_ValidatorWithBlsKey_dispatcher_url, value) {
			return
		}
	}
}
...
func (x *fastReflection_ValidatorWithBlsKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "hetu.checkpointing.v1.ValidatorWithBlsKey.dispatcher_url":
		panic(fmt.Errorf("field dispatcher_url of message hetu.checkpointing.v1.ValidatorWithBlsKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: hetu.checkpointing.v1.ValidatorWithBlsKey"))
		}
...
func (x *fastReflection_ValidatorWithBlsKey) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.DispatcherUrl) > 0 {
			i -= len(x.DispatcherUrl)
			copy(dAtA[i:], x.DispatcherUrl)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.DispatcherUrl)))
			i--
			dAtA[i] = 0x22
		}
		if x.VotingPower != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				x.DispatcherUrl = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func init() {
	file_hetu_checkpointing_v1_checkpoint_proto_init()
	md_Validator = File_hetu_checkpointing_v1_checkpoint_proto.Messages().ByName("Validator")
...
func (x *Validator) slowProtoReflect() protoreflect.Message {
	mi := &file_hetu_checkpointing_v1_checkpoint_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Validator) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message hetu.checkpointing.v1.Validator does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Validator) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message hetu.checkpointing.v1.Validator does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Validator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "hetu.checkpointing.v1.Validator.addr":
		panic(fmt.Errorf("field addr of message hetu.checkpointing.v1.Validator is not mutable"))
	case "hetu.checkpointing.v1.Validator.power":
		panic(fmt.Errorf("field power of message hetu.checkpointing.v1.Validator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: hetu.checkpointing.v1.Validator"))
		}
...
func (x *fastReflection_Validator) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in hetu.checkpointing.v1.Validator", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Validator) Descriptor() ([]byte, []int) {
	return file_hetu_checkpointing_v1_checkpoint_proto_rawDescGZIP(), []int{6}
}
...
var file_hetu_checkpointing_v1_checkpoint_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xac, 0x01, 0x0a, 0x13, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x57,
	...
	,
	...
	,
...
var file_hetu_checkpointing_v1_checkpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_hetu_checkpointing_v1_checkpoint_proto_goTypes = []interface{}{
	...
	(*Validator)(nil),              // 7: hetu.checkpointing.v1.Validator
...
var file_hetu_checkpointing_v1_checkpoint_proto_depIdxs = []int32{
	...
	8, // 4: hetu.checkpointing.v1.CheckpointStateUpdate.block_time:type_name -> google.protobuf.Timestamp
...
func file_hetu_checkpointing_v1_checkpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_hetu_checkpointing_v1_checkpoint_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
