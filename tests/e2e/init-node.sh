...
node_address=$(hhubd keys list | grep "address: " | cut -c12-)
...
hhubd start "$TRACE" --log_level $LOGLEVEL --minimum-gas-prices=0.0001ahhub --json-rpc.api eth,txpool,personal,net,debug,web3